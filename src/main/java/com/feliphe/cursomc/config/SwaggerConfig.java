...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.feliphe.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				...
				, "Esta API é ultilizada no curso Spring Boot do prof. Nelio Alves"
				, "Versão 1.0"
				, "https://www.udemy.com/terms"
				, new Contact("Feliphe Costa Marinho", "https://github.com/ContaTesteMarinho", "feliphemarinho18@gmail.com")
