...
import com.feliphe.cursomc.pagamento.domain.Pagamento;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria c3 = new Categoria(3, "Cama mesa e banho");
		Categoria c4 = new Categoria(4, "Eletrônicos");
		Categoria c5 = new Categoria(5, "Jardinagem");
		Categoria c6 = new Categoria(6, "Decoração");
		Categoria c7 = new Categoria(7, "Perfumaria");
